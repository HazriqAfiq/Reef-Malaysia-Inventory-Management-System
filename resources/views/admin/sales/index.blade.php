<x-app-layout title="Global Sales">
    ...
    <div class="bg-white rounded-3xl border border-gray-100 shadow-sm p-4 mb-8 flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        ...
        <form method="GET" action="{{ route('admin.sales.index') }}" id="filter-form" class="flex flex-col sm:flex-row sm:items-center gap-3 w-full">
        ...
        <div class="col-span-1 lg:col-span-3 bg-white rounded-3xl border border-gray-100 shadow-md shadow-gray-200/40 p-7 relative">
            <div class="flex items-center justify-between mb-6">
                <div>
                    ...
                    <p class="text-[12px] font-medium text-gray-500 mt-1">Aggregated platform revenue & volume for {{ $periodLabel }}</p>
                </div>
                            ...
                            <td class="px-7 py-4.5">
                                <div class="flex items-center gap-2">
                                    <div class="w-7 h-7 rounded-full bg-blue-100 flex items-center justify-center text-blue-700 font-bold text-[10px] shrink-0">
                                        {{ $sale->user ? strtoupper(substr($sale->user->name, 0, 2)) : 'GS' }}
                                    </div>
                                    <span class="text-[13px] font-medium text-gray-900 truncate">{{ $sale->user->name ?? 'Guest / Storefront' }}</span>
                                </div>
                            </td>
                            <td class="px-7 py-4.5">

<x-app-layout title="Add Product">
    ...
    <div class="max-w-4xl mx-auto">
        ...
        <div class="bg-white rounded-3xl border border-gray-100 shadow-md shadow-gray-200/40 overflow-hidden">
            ...
            <form action="{{ route('admin.products.store') }}" method="POST" class="p-8 space-y-8">
                @csrf
                ...
                <div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                        <div>
                            <label for="volume_ml" class="block text-[13px] font-bold text-gray-700 mb-2">Volume (ml)</label>
                        ...
                        <div>
                            ...
                            <div class="relative">
                                ...
                                <input id="wholesale_price" name="wholesale_price" type="number" step="0.01" value="{{ old('wholesale_price') }}" min="0" placeholder="0.00"
                        ...
                        <div>
                            ...
                            <div class="relative">
                                <span class="absolute left-4 top-1/2 -translate-y-1/2 text-[14px] text-gray-400 font-bold">RM</span>
                                <input id="retail_price" name="retail_price" type="number" step="0.01" value="{{ old('retail_price') }}" min="0" placeholder="0.00"
                                       class="w-full pl-11 pr-4 py-3 text-[14px] font-medium text-gray-900 bg-gray-50/50 border rounded-xl transition-all duration-300
                                              focus:outline-none focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500
                        ...
                        <div>
                            <label for="stock" class="block text-[13px] font-bold text-gray-700 mb-2">Initial Stock <span class="text-red-500">*</span></label>

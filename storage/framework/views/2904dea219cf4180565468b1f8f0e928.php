    ...
    <div class="grid grid-cols-2 lg:grid-cols-4 gap-5 mb-8">
        ...
        <div class="bg-white rounded-3xl border border-gray-100 shadow-sm hover:shadow-lg shadow-gray-200/50 p-5 relative overflow-hidden group hover:-translate-y-1 transition-all duration-300">
            ...
            <div class="relative z-10">
                ...
                <p class="text-2xl font-black text-gray-900 tracking-tight"><?php echo e($totalProducts); ?></p>
            </div>
        </div>
        ...
        <div class="bg-white rounded-3xl border border-gray-100 shadow-sm hover:shadow-lg shadow-gray-200/50 p-5 relative overflow-hidden group hover:-translate-y-1 transition-all duration-300">
            ...
            <div class="relative z-10">
                ...
                <div class="flex items-end justify-between">
                    <div>
                        <p class="text-2xl font-black text-gray-900 tracking-tight"><?php echo e(number_format($totalStock)); ?></p>
                        <p class="text-[10px] font-bold text-gray-500 mt-1">
                            <?php echo e(number_format($adminStock)); ?> Admin &middot; <?php echo e(number_format($resellerStock)); ?> Reseller
                        </p>
                    </div>
                </div>
            </div>
        ...
        <div class="bg-white rounded-3xl border border-gray-100 shadow-sm hover:shadow-lg shadow-gray-200/50 p-5 relative overflow-hidden group hover:-translate-y-1 transition-all duration-300">
            ...
            <div class="relative z-10">
                ...
                <p class="text-2xl font-black <?php echo e($lowStockCount > 0 ? 'text-amber-600' : 'text-gray-900'); ?> tracking-tight"><?php echo e($lowStockCount); ?></p>
            </div>
        </div>
        ...
        <div class="bg-white rounded-3xl border border-gray-100 shadow-sm hover:shadow-lg shadow-gray-200/50 p-5 relative overflow-hidden group hover:-translate-y-1 transition-all duration-300">
            ...
            <div class="relative z-10">
                ...
                <p class="text-2xl font-black <?php echo e($outOfStock > 0 ? 'text-red-600' : 'text-gray-900'); ?> tracking-tight"><?php echo e($outOfStock); ?></p>
            </div>
        </div>
    </div>
    ...
    <div class="bg-white rounded-3xl border border-gray-100 shadow-sm p-5 mb-6">
        <form id="filter-form" method="GET" action="<?php echo e(route('admin.products.index')); ?>" class="flex flex-col lg:flex-row gap-4">
            ...
            <div class="relative flex-1 flex gap-2">
                ...
                <div class="relative flex-1">
                    ...
                    <button type="button" id="search-clear"
                            onclick="clearSearch()"
                            class="absolute right-3 top-1/2 -translate-y-1/2 text-gray-400 hover:text-gray-700 transition-colors <?php echo e(request('search') ? '' : 'hidden'); ?>">
                        <svg class="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2.5">
            ...
            <select name="sort"
                ...
                <option value="retail_price"  <?php echo e(request('sort') === 'retail_price'  ? 'selected' : ''); ?>>Retail Price ↓</option>
                <option value="wholesale_price" <?php echo e(request('sort') === 'wholesale_price' ? 'selected' : ''); ?>>Wholesale Price ↓</option>
        ...
        <div class="px-7 py-5 border-b border-gray-50/80 flex items-center justify-between">
            <div>
                ...
                <p class="text-xs font-medium text-gray-500 mt-1">
                    Showing <?php echo e($products->count()); ?> out of <?php echo e($totalProducts); ?> total products.
                </p>
            </div>
        </div>
                    ...
                    <?php $__empty_1 = true; $__currentLoopData = $products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <tr class="hover:bg-gray-50/60 transition-colors duration-100">
                            ...
                            <td class="px-7 py-4.5 whitespace-nowrap">
                                <p class="text-[13px] font-medium text-gray-900"><?php echo e($product->name); ?></p>
                                <p class="text-[11px] font-medium text-gray-400 mt-0.5 tracking-wider uppercase">
                                    <?php echo e($product->sku); ?><?php if($product->category): ?> &middot; <span class="text-gray-500"><?php echo e(ucfirst($product->category->name)); ?></span><?php endif; ?>
                                </p>
                                <?php if($product->isPromotionActive()): ?>
                                    <div class="mt-1.5">
                                        <span class="inline-flex items-center gap-1 text-[9px] font-bold px-2 py-0.5 rounded text-amber-700 bg-amber-50 border border-amber-100">
                                            ...
                                            <?php echo e($product->promotion_badge ?? 'PROMO'); ?>
                            ...
                            <td class="px-7 py-4.5 hidden lg:table-cell min-w-[200px]">
                                <div class="flex flex-wrap gap-1.5 align-middle">
                                    <?php if($product->top_note): ?>
                                        <span class="text-[10px] font-bold bg-blue-50 border border-blue-100/50 text-blue-600 px-2 py-0.5 rounded-md shadow-sm" title="Top Note">T: <?php echo e($product->top_note); ?></span>
                                    <?php endif; ?>
                                    <?php if($product->heart_note): ?>
                                        <span class="text-[10px] font-bold bg-rose-50 border border-rose-100/50 text-rose-600 px-2 py-0.5 rounded-md shadow-sm" title="Heart Note">H: <?php echo e($product->heart_note); ?></span>
                                    <?php endif; ?>
                                    <?php if($product->base_note): ?>
                                        <span class="text-[10px] font-bold bg-amber-50 border border-amber-100/50 text-amber-600 px-2 py-0.5 rounded-md shadow-sm" title="Base Note">B: <?php echo e($product->base_note); ?></span>
                                    <?php endif; ?>
                                </div>
                            </td>
                            ...
                            <td class="px-7 py-4.5 text-right whitespace-nowrap">
                                <p class="text-[14px] font-black text-gray-900">
                                    <span class="text-[9px] font-bold text-gray-400 mr-1 uppercase">Retail:</span>RM<?php echo e(number_format($product->retail_price, 2)); ?>

                                </p>
                                <p class="text-[10px] font-bold text-gray-400 mt-0.5 tracking-tight">WS: RM<?php echo e(number_format($product->wholesale_price, 2)); ?></p>
                            </td>
                            ...
                            <td class="px-7 py-4.5">
                                ...
                                <div class="flex items-center justify-between mb-1.5">
                                    <div class="flex flex-col">
                                        <span class="text-[11px] font-black text-gray-900"><?php echo e(number_format($combinedStock)); ?> <span class="text-gray-400 text-[10px] font-bold">TOTAL</span></span>
                                ...
                                <div class="w-full bg-gray-100 rounded-full h-1.5 overflow-hidden shadow-inner">
                                    <div class="h-1.5 rounded-full <?php echo e($barColor); ?> transition-all duration-1000 ease-in-out" style="width: <?php echo e($percent); ?>%"></div>
                                </div>
                            </td>
                            ...
                            <td class="px-7 py-4.5 text-right">
                                <div class="flex items-center justify-end gap-2">
                                    ...
                                    <button type="button"
                                            onclick="confirmDelete('<?php echo e(route('admin.products.destroy', $product)); ?>', '<?php echo e(addslashes($product->name)); ?>')"
                    ...
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                        <tr>
                            <td colspan="7" class="py-16 text-center">
                                ...
                                <a href="<?php echo e(route('admin.products.index')); ?>" class="text-[12px] font-bold text-blue-600 bg-blue-50 px-4 py-2 rounded-xl hover:bg-blue-100 transition-colors inline-flex cursor-pointer">Clear all filters</a>
                            </td>
                        </tr>
                    <?php endif; ?>
                </tbody>

...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.storefront-layout','data' => ['title' => 'Your Signature Aura','darkHero' => true,'hasHero' => true]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['title' => 'Your Signature Aura','darkHero' => true,'hasHero' => true]); ?>
    <div x-data="{}">
    <style>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.scroll-indicator','data' => ['target' => 'selection']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['target' => 'selection']); ?>
        ...
        <div class="max-w-[1600px] mx-auto py-24 px-6 sm:px-8 lg:px-12">
            ...
            <?php if($recommendations->isEmpty()): ?>
                <div class="text-center py-32 bg-[#F9F9F9] rounded-[40px] border border-gray-100">
                    ...
                    <a href="<?php echo e(route('storefront.collection')); ?>" class="inline-flex items-center gap-4 text-[10px] font-bold uppercase tracking-[0.4em] text-black border-b border-black pb-2 hover:gap-6 transition-all duration-500">
            ...
            <?php else: ?>
                        ...
                        <div class="relative flex flex-col lg:flex-row items-stretch bg-white rounded-[2.5rem] overflow-hidden border border-gray-100 shadow-[0_25px_70px_rgba(0,0,0,0.03)] transition-all duration-700 hover:shadow-[0_40px_90px_rgba(0,0,0,0.07)]">
                            ...
                            <div class="lg:w-[55%] relative min-h-[400px] lg:min-h-[500px] overflow-hidden flex items-center justify-center bg-gradient-to-br from-[#FAFAFA] via-white to-[#FAFAFA]">
                                ...
                                <div class="relative z-10 w-full h-full flex items-center justify-center p-8 transition-all duration-[2000ms] group-hover:scale-105">
                                    <img src="<?php echo e($topMatch->primaryImage ? asset('storage/' . $topMatch->primaryImage->image_path) : 'https://placehold.co/1200x1200?text=' . urlencode($topMatch->name)); ?>" 
                            ...
                            <div class="lg:w-[45%] bg-white p-8 md:p-10 lg:p-12 flex flex-col justify-between border-l border-gray-50 relative">
                                ...
                                <div class="space-y-6 relative z-10">
                                    ...
                                    <div class="flex items-center justify-between">
                                        <div class="inline-flex items-center gap-3 px-4 py-2 bg-white border border-gray-100 rounded-full shadow-sm">
                                            <div class="flex items-center gap-2">
                                                ...
                                                <span class="text-[10px] font-black text-gray-900 tracking-tight"><?php echo e($accuracy); ?>% Match</span>
                                            </div>
                                            <div class="w-[1px] h-3 bg-gray-200"></div>
                                            <span class="text-[9px] font-bold uppercase tracking-[0.2em] text-gray-400">For You</span>
                                        </div>
                                        <span class="text-[9px] font-bold uppercase tracking-[0.4em] text-gray-300"><?php echo e($topMatch->category?->name ?? 'Fragrance'); ?></span>
                                    </div>

                                    <!-- Product Identity -->
                                    <div class="space-y-2">
                                        <h2 class="text-4xl md:text-5xl font-luxury leading-tight text-gray-900 tracking-tight">
                                            <?php echo e($topMatch->name); ?>

                                        </h2>
                                        <p class="text-[14px] font-light text-gray-500 leading-relaxed italic serif">
                                            "<?php echo e($topMatch->scent_profile ?? 'A harmonious blend of citrus top notes with a deep, lingering woody essence.'); ?>"
                                        </p>
                                    </div>
                                    ...
                                    <div class="space-y-4 pt-2">
                                        ...
                                        <div class="flex flex-wrap gap-2">
                                            <?php $__currentLoopData = array_filter([$topMatch->top_note, $topMatch->heart_note, $topMatch->base_note]); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $note): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    ...
                                    <div class="flex items-center gap-4 text-[9px] font-bold uppercase tracking-[0.3em] text-gray-400 pt-2">
                                        <span class="flex items-center gap-2"><div class="w-1 h-1 bg-gray-200 rounded-full"></div> <?php echo e(ucfirst($answers['vibe'] ?? 'Classic')); ?></span>
                                        <span class="flex items-center gap-2"><div class="w-1 h-1 bg-gray-200 rounded-full"></div> <?php echo e(ucfirst($answers['intensity'] ?? 'Balanced')); ?></span>
                                        <span class="flex items-center gap-2"><div class="w-1 h-1 bg-gray-200 rounded-full"></div> <?php echo e(ucfirst($answers['time'] ?? 'All Day')); ?></span>
                                    </div>
                                </div>
                                ...
                                <div class="mt-10 pt-8 border-t border-gray-50 space-y-6 relative z-10">
                                    ...
                                    <div class="text-left">
                                        <a href="<?php echo e(route('storefront.scent-finder')); ?>" class="inline-flex items-center gap-3 text-[8px] font-bold uppercase tracking-[0.3em] text-gray-400 hover:text-black transition-colors group/link">
                ...
                <?php if($otherMatches->isNotEmpty()): ?>
                    <div class="pt-32 border-t border-gray-100">
                        ...
                        <div class="flex flex-wrap justify-center gap-x-8 gap-y-16 reveal reveal-delay-200">
                            <?php $__currentLoopData = $otherMatches; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                ...
                <div class="mt-32 mb-16 text-center">
                    <div class="max-w-4xl mx-auto p-12 md:p-20 rounded-[3.5rem] bg-[#FAFAFA] border border-gray-50 relative overflow-hidden group shadow-sm transition-all duration-700 hover:shadow-md">
                        <div class="relative z-10 space-y-8">
                            ...
                            <div class="pt-2">
                                <a href="<?php echo e(route('storefront.scent-finder')); ?>" class="group/btn inline-flex flex-col items-center gap-4">
...
<?php /**PATH C:\Users\USER\Documents\Project Code\rpims\resources\views/storefront/scent-finder/results.blade.php ENDPATH**/ ?>
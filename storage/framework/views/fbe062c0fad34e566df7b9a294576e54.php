...
<?php $component->withAttributes(['title' => 'Manage Resellers']); ?>
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
        ...
        <div class="bg-white rounded-3xl border border-gray-100 shadow-sm hover:shadow-lg shadow-gray-200/50 p-6 relative overflow-hidden group hover:-translate-y-1 transition-all duration-300">
            ...
            <div class="relative z-10">
                ...
                <p class="text-2xl font-black text-gray-900 tracking-tight"><?php echo e($totalResellers); ?></p>
            </div>
        </div>
        ...
        <div class="bg-white rounded-3xl border border-gray-100 shadow-sm hover:shadow-lg shadow-gray-200/50 p-6 relative overflow-hidden group hover:-translate-y-1 transition-all duration-300">
            ...
            <div class="relative z-10">
                ...
                <p class="text-2xl font-black text-gray-900 tracking-tight"><?php echo e(number_format($totalSalesCount)); ?></p>
            </div>
        </div>
        ...
        <div class="bg-white rounded-3xl border border-gray-100 shadow-sm hover:shadow-lg shadow-gray-200/50 p-6 relative overflow-hidden group hover:-translate-y-1 transition-all duration-300">
            ...
            <div class="relative z-10">
                ...
                <p class="text-2xl font-black text-gray-900 tracking-tight">RM<?php echo e(number_format($totalRevenue, 2)); ?></p>
            </div>
        </div>
    </div>
    ...
    <div class="bg-white rounded-3xl border border-gray-100 shadow-md shadow-gray-200/40 p-5 mb-6 flex gap-3">
        <form method="GET" action="<?php echo e(route('admin.resellers.index')); ?>" class="flex w-full gap-3">
        ...
        <div class="px-7 py-5 border-b border-gray-50 flex items-center justify-between">
            <div>
                ...
                <p class="text-xs font-medium text-gray-500 mt-1">
                    Showing <?php echo e($resellers->firstItem() ?? 0); ?>–<?php echo e($resellers->lastItem() ?? 0); ?> of <?php echo e($resellers->total()); ?> accounts
                </p>
            </div>
        </div>
                        ...
                        <tr class="hover:bg-gray-50/60 transition-colors duration-100">
                            ...
                            <td class="px-7 py-4.5">
                                <div class="flex items-center gap-3">
                                    ...
                                    <div>
                                        <p class="text-[14px] font-medium text-gray-900"><?php echo e($reseller->name); ?></p>
                                        <p class="text-[12px] font-medium text-gray-400 mt-0.5"><?php echo e($reseller->email); ?></p>
                                    </div>
                                </div>
                            </td>
                            ...
                            <td class="px-7 py-4.5 text-center">
                                <span class="inline-flex items-center justify-center min-w-[2.5rem] px-1.5 h-6 rounded-lg bg-gray-100 border border-gray-200 text-gray-900 text-[12px] font-medium shadow-sm">
                                    <?php echo e(number_format($reseller->sales_count)); ?>
                            ...
                            <td class="px-7 py-4.5 text-right">
                                <p class="text-[15px] font-black text-gray-900">
                                    RM<?php echo e(number_format($reseller->sales_sum_total_price ?? 0, 2)); ?>
                            ...
                            <td class="px-7 py-4.5 hidden sm:table-cell">
                                <p class="text-[13px] font-medium text-gray-900"><?php echo e($reseller->created_at->format('d M Y')); ?></p>
                                <p class="text-[11px] font-medium text-gray-400 uppercase tracking-wider mt-0.5"><?php echo e($reseller->created_at->diffForHumans()); ?></p>
                            </td>
                        ...
                        <tr>
                            <td colspan="5" class="px-7 py-16 text-center">
                                ...
                                <?php if(request('search')): ?>
                                    ...
                                    <a href="<?php echo e(route('admin.resellers.index')); ?>" class="text-[12px] font-bold text-blue-600 bg-blue-50 px-4 py-2 rounded-xl hover:bg-blue-100 transition-colors inline-flex cursor-pointer">Clear Search</a>
                                <?php endif; ?>
                            </td>
                        </tr>
                    <?php endif; ?>

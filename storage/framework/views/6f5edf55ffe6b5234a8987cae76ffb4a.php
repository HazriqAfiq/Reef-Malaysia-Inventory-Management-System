...
<?php $component->withAttributes(['title' => 'Global Sales']); ?>
    ...
    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-6">
        <div>
            <h1 class="text-xl font-bold text-gray-900 tracking-tight">Global Sales</h1>
            <p class="text-sm font-medium text-gray-500 mt-1">All registered transactions across authorized resellers</p>
        </div>
        <a href="<?php echo e(route('admin.sales.report', ['year' => $selectedYear, 'month' => $selectedMonth])); ?>"
           class="inline-flex items-center gap-2 px-4 py-2 bg-white hover:bg-gray-50 border border-gray-200 text-gray-700 text-[13px] font-bold rounded-xl transition-all duration-300 hover:shadow-sm shrink-0">
    ...
    <div class="bg-white rounded-3xl border border-gray-100 shadow-sm p-4 mb-8 flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        ...
        <form method="GET" action="<?php echo e(route('admin.sales.index')); ?>" id="filter-form" class="flex flex-col sm:flex-row sm:items-center gap-3 w-full">
        ...
        <div class="col-span-1 flex flex-col gap-5">
            ...
            <div class="bg-white rounded-3xl border border-gray-100 shadow-sm hover:shadow-lg shadow-gray-200/50 p-5 relative overflow-hidden group hover:-translate-y-1 transition-all duration-300 flex-1">
                ...
                <div class="relative z-10">
                    <p class="text-[11px] font-bold text-gray-400 uppercase tracking-wider mb-1">Global Revenue</p>
                    <p class="text-2xl font-black text-gray-900 tracking-tight">RM<?php echo e(number_format($monthRevenue, 0)); ?></p>
                </div>
            </div>
            ...
            <div class="bg-white rounded-3xl border border-gray-100 shadow-sm hover:shadow-lg shadow-gray-200/50 p-5 relative overflow-hidden group hover:-translate-y-1 transition-all duration-300 flex-1">
                ...
                <div class="relative z-10">
                    ...
                    <p class="text-2xl font-black text-gray-900 tracking-tight"><?php echo e(number_format($monthUnitsSold)); ?></p>
                </div>
            </div>
            ...
            <div class="bg-white rounded-3xl border border-gray-100 shadow-sm hover:shadow-lg shadow-gray-200/50 p-5 relative overflow-hidden group hover:-translate-y-1 transition-all duration-300 flex-1">
                ...
                <div class="relative z-10">
                    ...
                    <p class="text-2xl font-black text-gray-900 tracking-tight"><?php echo e(number_format($monthTransactions)); ?></p>
                </div>
            </div>
        </div>
        ...
        <div class="col-span-1 lg:col-span-3 bg-white rounded-3xl border border-gray-100 shadow-md shadow-gray-200/40 p-7 relative">
            <div class="flex items-center justify-between mb-6">
                <div>
                    ...
                    <p class="text-[12px] font-medium text-gray-500 mt-1">Aggregated platform revenue & volume for <?php echo e($periodLabel); ?></p>
                </div>
        ...
        <div class="px-7 py-5 border-b border-gray-50/80 flex items-center justify-between">
            <div>
                ...
                <p class="text-xs font-medium text-gray-500 mt-1">
                    <?php echo e($monthTransactions); ?> processing <?php echo e(Str::plural('record', $monthTransactions)); ?>

                </p>
            </div>
            <?php if($monthTransactions > 0): ?>
                        ...
                        <tr class="hover:bg-gray-50/60 transition-colors duration-100">
                            ...
                            <td class="px-7 py-4.5">
                                <div class="flex items-center gap-2">
                                    <div class="w-7 h-7 rounded-full bg-blue-100 flex items-center justify-center text-blue-700 font-bold text-[10px] shrink-0">
                                        <?php echo e($sale->user ? strtoupper(substr($sale->user->name, 0, 2)) : 'GS'); ?>

                                    </div>
                                    <span class="text-[13px] font-medium text-gray-900 truncate"><?php echo e($sale->user->name ?? 'Guest / Storefront'); ?></span>
                                </div>
                            </td>
                            <td class="px-7 py-4.5">
                        ...
                        <tr>
                            <td colspan="6" class="px-7 py-16 text-center">
                                <div class="flex flex-col items-center gap-3">
                                    ...
                                    <p class="text-[12px] text-gray-500">Wait for your team to log sales or adjust your timeframe filter.</p>
                                </div>
                            </td>
                        </tr>
                    <?php endif; ?>
                ...
                <?php if($sales->count() > 0): ?>
                    <tfoot>
                        <tr class="border-t border-gray-100 bg-gray-50/80">
                            <td colspan="4" class="px-7 py-5 text-[11px] font-bold text-gray-500 uppercase tracking-widest text-right">
                                Page Total
                            </td>
